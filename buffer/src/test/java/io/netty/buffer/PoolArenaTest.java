...
public class PoolArenaTest {
    ...
    @Test
    public void test() {
        PoolArena<byte[]> arena = new PoolArena.HeapArena (null, PAGE_SIZE, PAGE_SHIFTS, CHUNK_SIZE);
        PoolThreadCache cache = new PoolThreadCache (arena, null, 5, 5, Integer.MAX_VALUE, 5);
        arena.allocate (cache, 71680, Integer.MAX_VALUE);
    }
